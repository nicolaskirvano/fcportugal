...
title: "Momentum de Liga Portugal no EA FC em 19/06 — PS"
draft: false
featured: true
tags:
  - investimentos
...
**João Moutinho** liderou o recorte com **+63,5% em 7d** e +3,7% em 24h. Entre 6 cartas, 6 tinham as duas janelas positivas; a mediana semanal foi **+20,0%**.

Os preços destacados iam de **20k coins** a **187k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Liga Portugal no EA FC em 19/06 — PS](/charts/melhores-investimentos-ea-fc-2026-06-19-ps.svg)
