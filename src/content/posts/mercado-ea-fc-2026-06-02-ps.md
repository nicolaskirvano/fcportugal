...
title: "Liga Portugal no EA FC hoje (02/06/2026): mercado, altas, baixas e previsões — Console (PS)"
draft: false
featured: true
tags:
  - mercado
...
faq:
  ...
  - q: "E a maior queda do dia?"
    a: "Anatoliy Trubin (88), -28.3% em 24h, a 172k coins."
...
Em **02/06/2026**, o mercado do **EA FC Ultimate Team** no **Console (PS)** está em mercado **em alta** — predominam as valorizações: das cartas relevantes (80+ acima de 5k coins), **18 subiram** e **26 caíram**, com variação média de **3.7%** nas últimas 24 horas. Mercado comprador — cuidado para não pagar topo em cartas já esticadas.
...
- **José Fonte (85)** subiu **+28.2%** em 24h, a **40k coins** (faixa do dia: 28k–48k). Está +9% acima da média de 7 dias (aquecida). O modelo vê **estabilização** no curto prazo.
...
- **Anatoliy Trubin (88)** caiu **-28.3%** em 24h, a **172k coins** (faixa do dia: 170k–240k). Está -16% abaixo da média de 7 dias (descontada). 🔮 O modelo projeta **recuperação** (reversão para alta), com 95% de probabilidade.
